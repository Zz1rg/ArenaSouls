...
int main()
{
	...
	Model ourModel("resources/objects/idle-mixamo/Warrior Idle.dae");
	Animation idleAnimation("resources/objects/idle-mixamo/Warrior Idle.dae", &ourModel);
	Animation walkAnimation("resources/objects/walk-inplace-mixamo/Walking.dae", &ourModel);
	Animation runAnimation("resources/objects/run-inplace-mixamo/Fast Run.dae", &ourModel);
	//Animation stepAnimation("resources/objects/step-mixamo/Standing Dodge Backward.dae", &ourModel);
	Animation rollAnimation("resources/objects/roll-inplace-mixamo/Standing Dive Forward.dae", &ourModel);
